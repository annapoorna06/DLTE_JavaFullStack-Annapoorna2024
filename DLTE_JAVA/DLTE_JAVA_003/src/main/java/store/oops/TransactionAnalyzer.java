...
public class TransactionAnalyzer {
    public static void main(String[] args) {
        ...
        switch(choice){
            case 1:analyze.filterByDateRange(myBank);
                   break;
            case 2:analyze.leastAmountTransferred(myBank);
                   break;
            case 3:analyze.maxAmountTransferred(myBank);
                   break;
            case 4:analyze.countTransactionToBenificiary(myBank);
                   break;
            case 5:analyze.filterOnRemarks(myBank);
                   break;
            case 6:analyze.sortDescendingByBeneficiary(myBank);
                   break;
        }
