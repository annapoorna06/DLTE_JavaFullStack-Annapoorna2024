...
//import org.example.pojo.InputEmployeeDetails;
//import org.example.pojo.Employee;
//import org.example.pojo.EmployeeAddress;
//import org.example.pojo.EmployeebasicDetails;
...
//                                employeeBasicDetailsConsole= new EmployeebasicDetails(name, id, email, phoneNumber);
...
//                                basicDetails=translate(employeebasicDetails);
//                                permanentAddr=translatePermanentAddress(employeePermanentAddress);
//                                temporaryAddr=translateTemporaryAddress(employeeTemporaryAddress);
...
//        }
//
//        private static EmployeeAddress translateTemporaryAddress(EmployeeAddress employeeTemporaryAddressConsole) {
//            EmployeeAddress employeeTemporaryAddress = new EmployeeAddress();
//            employeeTemporaryAddress.setAddress(employeeTemporaryAddressConsole.getAddress());
//            employeeTemporaryAddress.setHouseNumber(employeeTemporaryAddressConsole.getHouseNumber());
//            employeeTemporaryAddress.setCity(employeeTemporaryAddressConsole.getCity());
//            employeeTemporaryAddress.setState(employeeTemporaryAddressConsole.getState());
//            employeeTemporaryAddress.setPinCode(employeeTemporaryAddressConsole.getPinCode());
//            return  employeeTemporaryAddress;
//        }
//
//        private static EmployeeAddress translatePermanentAddress(EmployeeAddress employeePermanentAddressConsole) {
//            EmployeeAddress employeePermanentAddress = new EmployeeAddress();
//            employeePermanentAddress.setAddress(employeePermanentAddressConsole.getAddress());
//            employeePermanentAddress.setHouseNumber(employeePermanentAddressConsole.getHouseNumber());
//            employeePermanentAddress.setCity(employeePermanentAddressConsole.getCity());
//            employeePermanentAddress.setState(employeePermanentAddressConsole.getState());
//            employeePermanentAddress.setPinCode(employeePermanentAddressConsole.getPinCode());
//            return employeePermanentAddress;
//        }
//
//        private static EmployeebasicDetails translate(EmployeebasicDetails employeeBasicDetailsConsole) {
//            EmployeebasicDetails employeebasicDetails=new EmployeebasicDetails();
//            employeebasicDetails.setEmployeeName(employeeBasicDetailsConsole.getEmployeeName());
//            employeebasicDetails.setEmployeeId(employeeBasicDetailsConsole.getEmployeeId());
//            employeebasicDetails.setEmailId(employeeBasicDetailsConsole.getEmailId());
//            employeebasicDetails.setPhoneNumber(employeeBasicDetailsConsole.getPhoneNumber());
